...
2. 본 문서(`docs/validation-home-services.md`) 읽기
3. `FIGMA_TOKEN`은 이전 세션에서 이미 User scope 전역 세팅됨 — 확인 불필요. 직전 세션 smoke test 성공 (Home Services landing 6227×5387 PNG 3.4MB 추출 검증)
...
3. FIGMA_TOKEN은 이미 전역 세팅 + 직전 세션에서 smoke test 통과 — 건너뜀
