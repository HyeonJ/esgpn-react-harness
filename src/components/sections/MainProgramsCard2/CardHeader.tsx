...
/**
 * inner 카드 상단 블록 (Figma 252:1071).
 * - progress bar SVG (520×20, blue theme)
 * - h1 "ESG 실천 아이디어 경진대회" (36B gray-900 lh 1.3 ls -1.08px)
 * - 체크리스트 2줄 (bullet 3×16 rounded-24 bg-#3F9FFF + 16M 텍스트)
 */
const CHECK_ROWS = [
